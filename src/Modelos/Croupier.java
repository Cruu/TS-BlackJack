    ...
    public Boolean jugadorPuedeSeguir(Jugador jugador){
        ...
        if(!puedeSeguir) {
            if(jugador.obtenerTotalPuntos() == 21){
                ...
                System.out.println("El jugador: "+jugador.getNombre()+" ha perdido con \033[33m"+jugador.obtenerTotalPuntos()+" puntos\33[30m");
            }
        }
        return puedeSeguir;
    }
        ...
        do{
            ...
            if(jugador instanceof Croupier){
                ...
                if(jugador.obtenerTotalPuntos()>=21){
                    ...
                    System.out.print("¿Quiere otra carta?, tienes \033[33m"+jugador.obtenerTotalPuntos()+" puntos \033[30m(Respuestas: Si o No) ");
                    resp = scn.next();
                    System.out.println(" ");
                }
            }
